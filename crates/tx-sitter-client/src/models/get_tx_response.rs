...
pub struct GetTxResponse {
    ...
    #[serde(rename = "nonce")]
    pub nonce: i32,
    /// A hex encoded 256-bit hash
    #[serde(rename = "txHash", skip_serializing_if = "Option::is_none")]
    pub tx_hash: Option<base_api_types::H256>,
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<models::TxStatus>,
}

impl GetTxResponse {
    pub fn new(tx_id: String, to: base_api_types::Address, value: base_api_types::DecimalU256, gas_limit: base_api_types::DecimalU256, nonce: i32) -> GetTxResponse {
        GetTxResponse {
            tx_id,
            to,
            data: None,
