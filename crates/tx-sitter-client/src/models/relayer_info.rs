...
pub struct RelayerInfo {
    ...
    pub gas_price_limits: Vec<models::RelayerGasPriceLimit>,
    #[serde(rename = "enabled")]
    pub enabled: bool,
}

impl RelayerInfo {
    pub fn new(id: String, name: String, chain_id: i32, key_id: String, address: base_api_types::Address, nonce: i32, current_nonce: i32, max_inflight_txs: i32, max_queued_txs: i32, gas_price_limits: Vec<models::RelayerGasPriceLimit>, enabled: bool) -> RelayerInfo {
        RelayerInfo {
            id,
            name,
            chain_id,
